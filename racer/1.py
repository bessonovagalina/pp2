...
BACKGROUND = pygame.image.load("./Week9+10+11\Lab8\Racer\AnimatedStreet.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./Week9+10+11\Lab8\Racer\Player.png")
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        original_image = pygame.image.load("./Week9+10+11/Lab8/Racer/coin.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("./Week9+10+11/Lab8/Racer/Enemy.png")
        self.rect = self.image.get_rect()
